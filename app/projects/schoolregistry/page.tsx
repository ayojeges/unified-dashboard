        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Nigerian school registry and accreditation platform
            </p>
          </div>
        </div>
      ...
      <div className="grid gap-3 grid-cols-2 md:grid-cols-4">
        <Card>
          <CardContent className="pt-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <p className="text-sm font-medium">Registered Schools</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <p className="text-sm font-medium">Pending Accreditations</p>
                <p className="text-lg sm:text-2xl font-bold">0</p>
              </div>
